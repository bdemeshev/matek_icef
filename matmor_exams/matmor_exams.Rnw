...
% RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW 
% RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW RNW 
...
<<fig.height=2,fig.width=2, echo=FALSE>>=
...
ggplot(h, aes(x=x, y=y, z=z)) + stat_contour() + theme_bw() + 
...
\begin{enumerate}
\item A two-product monopoly seeks to maximize its revenue which follows the formula $R(x,y)=6x-x^2+y-y^2$. The total costs function is given by $C(x,y)=x^2+y^2+4x+3y$, where $x$ and $y$ are the outputs.
...
\item 10 points for conversion to the dual program and correct analysis of the feasible region. The rest 10 points for maximizing objective function. The smart students who have noticed the obvious solution in Variant 3 would get full points immediately.
...
5 points for stating FOC and 5 points for obtaining strategy from FOC. The final answer is $b_i=\frac{3}{8}v_i$.
...
\begin{enumerate}
\item A two-product monopoly seeks to maximize its revenue which follows the formula $R(x,y)=x-x^2+6y-y^2$. The total costs function is given by $C(x,y)=x^2+y^2+3x+4y$, where $x$ and $y$ are the outputs.
...
\begin{enumerate}
\item A two-product monopoly seeks to maximize its revenue which follows the formula $R(x,y)=2x-x^2+8y-y^2$. The total costs function is given by $C(x,y)=x^2+y^2+3.5x+6y$, where $x$ and $y$ are the outputs.
...
\begin{enumerate}
\item A two-product monopoly seeks to maximize its revenue which follows the formula $R(x,y)=8x-x^2+2y-y^2$. The total costs function is given by $C(x,y)=x^2+y^2+6x+3.5y$, where $x$ and $y$ are the outputs.
