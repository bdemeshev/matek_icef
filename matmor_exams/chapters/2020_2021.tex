...
\begin{enumerate}
  ...
  7a
    \begin{itemize}
       \item Correct Hesse matrix in general form -- 2 points
       \item Correct Euler's theorem either in general or for the case of the homogeneous function of degree 1: $F'_K\cdot K + F'_L\cdot L = F$ -- 3 points
       \item Correct determinant calculation -- 1 point
       \item Correct statement of the Euler's theorem for the functions $F'_K$ and $F'_L$ (or equivalently correct differentiation of the formula given above):
       \begin{align*}
       F''_{KK}\cdot K + F''_{LK}\cdot L = 0\\
       F''_{KL}\cdot K + F''_{LL}\cdot L = 0
       \end{align*} -- 2 points
       \item Showing that usage of the formulas above lead to $det H = 0$ -- 2 points
       \item (1 additional point was given for the definition of homogeneous function - however, the total result for the task can't be bigger then 10 points)
       \item No extra points given for the proof in the particular case (e.g., for the linear function)
    \end{itemize}
    7b
     \begin{itemize}
        \item Any attempt to use Euler's theorem -- 2 points
        \item Correct usage of chain rule: $\dot Y = F'_K\cdot \dot K + F'_L \cdot \dot L$ -- 2 points
        \item Correct calculations -- 4 points
        \item The function $\alpha(t)$ given in explicit form: $\alpha(t) = \frac{L\cdot F'_L}{F}$ -- 2 points
     \end{itemize}
  \item %8
    \begin{itemize}
        \item Make use of the initial condition: conclude that $y(t) \neq const$ -- 1 point
        \item Correct characteristic equation -- 1 point
        \item Correct characteristic roots -- 1 point
        \item Clear statement and explanation that roots can't be complex -- 3 points
