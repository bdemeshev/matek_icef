...
\begin{enumerate}
  \item (10 points) Solve the difference equation $x_n - 10 x_{n-1} + 25 x_{n-2} = 2^n$.

  \item (10 points) Solve the differential equation $y'' - 10 y' + 26 y = \cos t$.

\item (10 points) 
Find the second order Taylor approximation at a point $(0, 0)$ of the function 
\[
  f(x, y) = \cos(x + 4y) - \sin (4x + y).
\]
...
2 x_1 + 2 x_2 + 3x_3 \leq 14 \\
3 x_1 + 3 x_2 + 2x_3 \leq 14 \\ 
\end{cases}.
\]

\item (10 points) Solve the optimization problem 
\[
x^2 + y^2 + z^2 - 16x - 16y + 14 z \to \min
\]
subject to
\[
x + y \leq 15. 
...
\item (10 points) Sketch the set $A = \{z \mid z^2 + 3z \in \mathbb R\}$ on the complex plane $\mathbb C$.
