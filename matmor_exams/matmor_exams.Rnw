...
\item $x\frac{\partial u}{\partial x}+y\frac{\partial u}{\partial y}=2f'\frac{-x^2}{(x^2+y^2)^{3/2}}+2f'\frac{-y^2}{(x^2+y^2)^{3/2}}=-2f'(r)/r$. Derivatives $\frac{\partial u}{\partial x}$ and $\frac{\partial u}{\partial y}$ --- 3 points each. The remaining part --- 4 points.
