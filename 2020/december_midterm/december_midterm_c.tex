...
\item (10 points) Consider the function $f(x, y) = 2x^3 + 7y^2 x^2$ and the point $A(1,1)$.
\begin{enumerate}
...
\item (10 points) Consider the equation $3x^3 + 5y^5 + z^3 + 3z=12$. 
\begin{enumerate}
...
\item (10 points) Find all local extrema of the function $f(x, y) = x^2 y - 4xy^2 + 5xy +2$ such that $x\neq 0$ and $y\neq 0$. 
Classify them.

\item (10 points) Find all local constrained extrema 
of the function $f(x, y, z) = x + 2y + 5z$ subject to $\ln x + \ln y + \ln z = 0$.
Do not forget to classify extrema. 

\item (10 points) Consider the function $f(x, y) = h(x) g(y) + ax^7$, where $h$ and $g$ are twice differentiable
...
Draw two level curves of the function $g(x,y)=f(x-5, |y| + 4)$.
