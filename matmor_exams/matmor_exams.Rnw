...
\begin{enumerate}
\item Lagrange function --- 1 pt, NDCQ --- 2 pts, correct FOC 
...
Each player has 4 strategies: guess head, guess tail, guess the result of his toss, guess the opposite of the result of his toss.
