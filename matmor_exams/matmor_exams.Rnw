...
\item general formula for second order Taylow expansion — 2 points, value at the initial point — 1 point, first order derivatives — 3 points, second order derivatives — 4 points.
\item point a — 2 points, $f'$ expressed using $f$ — 5 points, exact value of $f$ — 3 points.
\item
